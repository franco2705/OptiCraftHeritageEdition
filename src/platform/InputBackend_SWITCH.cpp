...
PlatformGamepadSnapshot platformRawGamepadSnapshot(int){ poll(); AnalogStickState l=padGetStickPos(&s_pad,0),r=padGetStickPos(&s_pad,1); return {padIsConnected(&s_pad),axis(l.x),-axis(l.y),axis(r.x),-axis(r.y)}; }
